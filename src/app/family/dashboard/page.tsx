      ...
      <main className="max-w-7xl mx-auto p-6 lg:p-10 space-y-10">
        ...
        {student ? (
              ...
              <div className="relative z-10 p-8 lg:p-12 space-y-10">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    {isProcessing ? (
                      <div className="flex items-center gap-3">
                        <Loader2 className="animate-spin h-5 w-5" /> Syncing with Central Bank...
                      </div>
                    ) : balance <= 0 ? (
                      <div className="flex items-center gap-3">
                  ...
                  <p className="text-[10px] text-center opacity-40 flex items-center justify-center gap-2 font-bold uppercase tracking-widest">
                    <CreditCard className="h-3 w-3" /> Encrypted processing by Paystack & KCB Bank
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Card className="p-20 text-center border-none shadow-[0_20px_60px_rgb(0,0,0,0.05)] bg-white rounded-[2.5rem]">
            ...
            <p className="text-muted-foreground text-sm max-w-sm mx-auto mb-10 leading-relaxed font-medium">Your account profile isn't currently linked to a validated student record. Please verify your admission credentials with the school registry.</p>
              ...
              {(!payments || payments.length === 0) && !paymentsLoading && (
                <div className="p-24 text-center flex flex-col items-center justify-center gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground font-bold tracking-tight max-w-xs mx-auto">Once you make a payment using the secure checkout above, it will appear here in your financial ledger.</p>
                  </div>
                </div>
              )}
            </Card>
