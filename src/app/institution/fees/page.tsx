...
export default function InstitutionFees() {
  ...
  const downloadExplanation = () => {
    if (!explanation || !selectedStudent) return;
    const content = `
FEE EXPLANATION: ${selectedStudent.name}
Generated by ScholarlyPay AI Assistant
-----------------------------------
${explanation}

-----------------------------------
Date: ${new Date().toLocaleDateString()}
Generated for Admission #: ${selectedStudent.admissionNumber}
    `;
    const element = document.createElement("a");
    const file = new Blob([content], {type: 'text/plain'});
    element.href = URL.createObjectURL(file);
    element.download = `Fee_Explanation_${selectedStudent.admissionNumber}.txt`;
    ...
    toast({
      ...
      description: "The fee explanation has been saved to your device.",
    });
  };
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="sm:max-w-[500px]">
                            ...
                            <DialogFooter className="flex gap-2">
                              ...
                              {explanation && (
                                <Button variant="outline" className="gap-2" onClick={downloadExplanation}>
